...
import { AGENT_ADAPTER_TYPES } from "@nanoclip/shared";
import type {
  Agent,
...
} from "@nanoclip/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@nanoclip/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@nanoclip/adapter-gemini-local";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
// Canonical type lives in @nanoclip/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@nanoclip/adapter-utils";
import type { CreateConfigValues } from "@nanoclip/adapter-utils";
...
const ENABLED_ADAPTER_TYPES = new Set(["ollama_local", "openrouter_local", "http"]);
