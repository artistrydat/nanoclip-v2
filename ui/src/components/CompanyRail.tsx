...
import type { Company } from "@nanoclip/shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* App brand - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <span className="text-[10px] font-bold tracking-tight text-foreground select-none leading-none text-center">Nano<br/>Clip</span>
      </div>
