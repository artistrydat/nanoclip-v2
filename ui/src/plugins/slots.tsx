 ...
 *
 * Plugin bundles are built with `external: ["@nanoclip/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@nanoclip/plugin-sdk/ui";
 ...
 * - `import { ... } from "@nanoclip/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@nanoclip/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@nanoclip/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@nanoclip/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@nanoclip/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@nanoclip/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
