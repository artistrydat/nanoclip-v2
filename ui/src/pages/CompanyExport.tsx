...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("```bash");
  lines.push("pnpm nanoclip company import this-github-url-or-folder");
  lines.push("```");
  lines.push("");
  lines.push("See [NanoClip](https://github.com/nanoclip/nanoclip) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from NanoClip on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
